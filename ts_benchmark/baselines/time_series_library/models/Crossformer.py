...
class Crossformer(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.enc_value_embedding = SRS(configs.d_model, self.seg_len, self.seg_len, self.seq_len, configs.srs_dropout, configs.srs_hidden_size, configs.srs_alpha, configs.srs_pos,config=configs)
