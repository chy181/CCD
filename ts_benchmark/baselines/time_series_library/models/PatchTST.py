...
class PatchTST(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.patch_embedding = SRS(config.d_model, self.patch_len, self.stride, self.seq_len, config.srs_dropout, config.srs_hidden_size, config.srs_alpha, config.srs_pos,config=config)
